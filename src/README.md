...
| [`grow/`](grow/) | `observe` · `stage` · `review` · `evolve` — the four loop verbs (the durable artifacts `generation`/`log` live in `notes/`) | [05](../docs/learn/05-how-the-system-grows.md) · [06](../docs/learn/06-observing-a-host.md) |
...
3. **`grow/`** — how it *grows* (observe → stage → review → evolve).
