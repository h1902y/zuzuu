...
export function TakeoverOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center gap-4 bg-background px-6 text-center">
      <span className="flex h-12 w-12 items-center justify-center rounded-[var(--radius-dialog)] bg-[var(--accent)] text-muted-foreground">
      ...
      <div className="wc-sans max-w-sm">
        <div className="text-display font-semibold text-foreground">Opened in another tab</div>
