...
import { sessionInspect, sessionTrace, sessionTree } from './sessions.mjs';
...
export function session(args = {}) {
  ...
  console.error(`unknown: zuzuu session ${sub}\nusage: zuzuu session [status|merge [--title t]|continue|discard --yes|inspect <id>|trace <id>|tree <id>]`);
  process.exit(1);
}
