...
import { readManifest, capabilitiesOf, listModules, moduleHas } from '../../zuzuu/kernel/module.mjs';
import { register, get, has, list, clear, invoke, describe } from '../../zuzuu/kernel/capability.mjs';
