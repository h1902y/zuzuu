...
> **What this is:** the canonical, single-file overview of the project — what we're building, why, the architecture, the decisions, and the research it stands on. It consolidates the prior set of concept/design docs into one entry point. Depth lives in [`inspiration/`](inspiration/) (the source-level audits and the 100-project field survey).
>
